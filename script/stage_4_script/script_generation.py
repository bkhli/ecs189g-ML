...
from local_code.stage_4_code.Method_Generation import Method_MLP
from local_code.stage_4_code.Result_Saver import Result_Saver
from local_code.stage_4_code.Setting import Setting_Train_Test
...
if 1:
    ...
    data_obj.dataset_source_file_name = 'text_generation'

    method_obj = Method_MLP('RNN', '')
    ...
    evaluate_obj_acc = Evalaute_Accuracy('accuracy', '')
